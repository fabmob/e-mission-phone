...
set -e
./bin/configure_xml_and_json.js tracemob

echo "Copying fake FCM configurations for android and iOS"
cp setup/tracemob/GoogleService-Info.plist GoogleService-Info.plist
cp setup/tracemob/google-services.json google-services.json
